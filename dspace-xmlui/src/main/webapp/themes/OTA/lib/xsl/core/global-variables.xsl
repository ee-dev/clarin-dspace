...
<xsl:stylesheet version="1.0"
    ...
    <xsl:variable name="theme-path" select="concat($context-path,'/themes/OTA')"/>
	...
	<xsl:variable name="theme-path-on-disk" select="concat(confman:getProperty('dspace.dir'),'/webapps/xmlui/themes/OTA')" />
