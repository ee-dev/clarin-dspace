    ...
    <xsl:template name="howto-panel">
                ...
                <ul class="submenu" style="padding-bottom: 8px;">
                        ...
                        <a href="{$context-path}/page/deposit" style="border-top: none; padding: 7px 0px 8px 18px">
                                <img src="{$context-path}/themes/OTAHome/lib/images/deposit.png" align="left" class="deposit" />
                        </a>
                        </li>
                        <li>
                                <a href="{$context-path}/page/cite" style="border-top: none; padding: 7px 0px 8px 18px;">
                                <img src="{$context-path}/themes/OTAHome/lib/images/cite.png" align="right" class="cite" />
                                </a>
                        </li>
                </ul>
    </xsl:template>
    ...
    <xsl:template name="languageSelection">
        ...
        <xsl:if test="count(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='page'][@qualifier='supportedLocale']) &gt; 1">
			...
			<img>
				...
				<xsl:value-of select="concat($context-path,'/themes/OTA/lib/lindat/public/img/flags/',$locale,'.png')"/>
			    </xsl:attribute>
