...
function simpleSearchFieldChange(aField)
{
// If the user selects an identifier field then set the relational_operator to 
//  'equals' [1]
// otherwise set it to 
//  'contains' [0]
var selectMenu = document.getElementById(aField)
var v = selectMenu.options[selectMenu.selectedIndex].value
var whichOperator = 1;//
var rx = new RegExp('_identifier');
if(!rx.test(v))
{
whichOperator=0;
}
...
//aspect_discovery_SimpleSearch_field_filter_relational_operator_1

rx = new RegExp("filtertype_(\\d)")
var match = rx.exec(aField);
if (match != null) {
	document.getElementById("aspect_discovery_SimpleSearch_field_filter_relational_operator_"+match[1]).options[whichOperator].selected = true
	}
}
